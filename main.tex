...
\cventry{2024-}{Energyflow}{Hosted at \url{energyflow.net}}{Install with $\texttt{pip install energyflow}$}{Python Package [Maintainer]}{Library of legacy tools developed before 2020 for jet physics -- Current package maintainer.}
